                    ...
                    <form action="" method="post" enctype="multipart/form-data" class="form">
                        ...
                        <div class="exam_type">
                            <div class="exam_type-sub">
                                ...
                                <input type="radio" class="radio" name="general_condition" value="acutely ill">
                                <label for="chronically" class="exam_type--label">chronically ill:</label>
                                <input type="radio" class="radio" name="general_condition" value="chronically ill">
                                <label for="normal" class="exam_type--label">Normal:</label>
                                <input type="radio" class="radio" name="general_condition"value="normal">
                            </div>
                            ...
                            <div class="edema">
                                ...
                                <div class="edema_sub">
                                    <div>
                                        <label class="exam_type--label" for="generalized">generalized</label>
                                    </div>
                                   <div>
                        ...
                        <div class="lab_test">
                            ...
                            <div class="form_group">
                                <div>
                                    <label for="blood group" class="form_label">b.blood group</label>
                                <input type="text" class="form_input" id="blood group" name="blood_group" placeholder="blood blood group"   required>
                                        ...
                                        <div class="urine_test_lue">
                                            ...
                                            <div class="urine_test_lue-main">
                                                <div class="urine_test_lue-sub">
                                                    ...
                                                    <div>
                                                        <input type="radio" name="urinalysis" value="leu +">
                                                    </div>
                                                </div>
                                                <div class="urine_test_lue-sub">
                                                    <div>
                                        ...
                                        <div class="urine_test_lue">
                                            ...
                                            <div class="urine_test_lue-main">
                                                <div class="urine_test_lue-sub">
                                                    ...
                                                    <div>
                                                        <input type="radio" name="urinalysis" value="nit +">
                                                    </div>
                                                </div>
                                                <div class="urine_test_lue-sub">
                                                    <div>
                                        ...
                                        <div class="urine_test_lue">
                                            ...
                                            <div class="urine_test_lue-main">
                                                <div class="urine_test_lue-sub">
                                                    ...
                                                    <div>
                                                        <input type="radio" name="urinalysis" value="uro +">
                                                    </div>
                                                </div>
                                                <div class="urine_test_lue-sub">
                                                    <div>
                                        ...
                                        <div class="urine_test_lue">
                                            ...
                                            <div class="urine_test_lue-main">
                                                <div class="urine_test_lue-sub">
                                                    ...
                                                    <div>
                                                        <input type="radio" name="urinalysis" value="pro +">
                                                    </div>
                                                </div>
                                                <div class="urine_test_lue-sub">
                                                    <div>
                                        ...
                                        <div class="urine_test_lue">
                                            ...
                                            <div class="urine_test_lue-main">
                                                <div class="urine_test_lue-sub">
                                                    ...
                                                    <div>
                                                        <input type="radio" name="urinalysis" value="blo +">
                                                    </div>
                                                </div>
                                                <div class="urine_test_lue-sub">
                                                    <div>
                                        ...
                                        <div class="urine_test_lue">
                                            ...
                                            <div class="urine_test_lue-main">
                                                <div class="urine_test_lue-sub">
                                                    ...
                                                    <div>
                                                        <input type="radio" name="urinalysis" value="ket +">
                                                    </div>
                                                </div>
                                                <div class="urine_test_lue-sub">
                                                    <div>
                                        ...
                                        <div class="urine_test_lue">
                                            ...
                                            <div class="urine_test_lue-main">
                                                <div class="urine_test_lue-sub">
                                                    ...
                                                    <div>
                                                        <input type="radio" name="urinalysis" value="glu +">
                                                    </div>
                                                </div>
                                                <div class="urine_test_lue-sub">
                                                    <div>
                                        ...
                                        <div class="urine_test_lue">
                                            ...
                                            <div class="urine_test_lue-main">
                                                <div class="urine_test_lue-sub">
                                                    ...
                                                    <div>
                                                        <input type="radio" name="urinalysis" value="bil +">
                                                    </div>
                                                </div>
                                                <div class="urine_sub">
                                                    <div>
                                        ...
                                        <div class="urine_test_lue">
                                            ...
                                            <div class="urine_test_lue-main">
                                                <div class="urine_test_lue-sub">
                                                    ...
                                                    <div>
                                                        <input type="radio" name="urinalysis" value="ph 5.0">
                                                    </div>
                                                </div>
                                                <div class="urine_sub">
                                                    <div>
                                                    ...
                                                    <div>
                                                        <input type="radio" name="urinalysis" value="ph 6.0">
                                                    </div>
                                                </div>
                                                <div class="urine_test_lue-sub">
                                                    <div>
                                                    ...
                                                    <div>
                                                        <input type="radio" name="urinalysis" value="ph 6.5">
                                                    </div>
                                                </div>
                                                <div class="urine_sub">
                                                    <div>
                                                    ...
                                                    <div>
                                                        <input type="radio" name="urinalysis" value="ph 7.0">
                                                    </div>
                                                </div>
                                                <div class="urine_test_lue-sub">
                                                    <div>
                                                    ...
                                                    <div>
                                                        <input type="radio" name="urinalysis" value="ph 7.5">
                                                    </div>
                                                </div>
                                                <div class="urine_sub">
                                                    <div>
                                                    ...
                                                    <div>
                                                        <input type="radio" name="urinalysis" value="ph 8.0">
                                                    </div>
                                                </div>
                                                <div class="urine_test_lue-sub">
                                                    <div>
                                                    ...
                                                    <div>
                                                        <input type="radio" name="urinalysis" value="ph 9.0">
                                                    </div>
                                                </div>
                                            </div>
                                        </div> 
                                     ...
                                     <div class="urine_test_lue">
                                        ...
                                        <div class="urine_test_lue-main">
                                            <div class="urine_test_lue-sub">
                                                ...
                                                <div>
                                                    <input type="radio" name="urinalysis" value="sg 1.000">
                                                </div>
                                            </div>
                                            <div class="urine_sub">
                                                <div>
                                                ...
                                                <div>
                                                    <input type="radio" name="urinalysis" value="sg 1.005">
                                                </div>
                                            </div>
                                            <div class="urine_test_lue-sub">
                                                <div>
                                                ...
                                                <div>
                                                    <input type="radio" name="urinalysis"value="sg 1.010">
                                                </div>
                                            </div>
                                            <div class="urine_sub">
                                                <div>
                                                ...
                                                <div>
                                                    <input type="radio" name="urinalysis" value="sg 1.015">
                                                </div>
                                            </div>
                                            <div class="urine_test_lue-sub">
                                                <div>
                                                ...
                                                <div>
                                                    <input type="radio" name="urinalysis" value="sg 1.020">
                                                </div>
                                            </div>
                                            <div class="urine_sub">
                                                <div>
                                                ...
                                                <div>
                                                    <input type="radio" name="urinalysis" value="sg 1.025">
                                                </div>
                                            </div>
                                            <div class="urine_test_lue-sub">
                                                <div>
                                                ...
                                                <div>
                                                    <input type="radio" name="urinalysis" value="sg 1.030">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="system__container">
                                ...
                                <input type="text" class="form_input" id="name" name="image_tittle" placeholder="enter image tittle" required>
